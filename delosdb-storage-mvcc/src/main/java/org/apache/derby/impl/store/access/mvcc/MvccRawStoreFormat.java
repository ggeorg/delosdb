...
final class MvccRawStoreFormat {
    ...
    static final String GEN2_SKIP_CURRENT_TAG_FETCH_ENABLED_PROPERTY =
            "delosdb.experimental.mvccGen2SkipCurrentTagFetch.enabled";
    static final String GEN2_LAZY_CURRENT_CREATOR_FETCH_ENABLED_PROPERTY =
    ...
    static final String GEN2_COMMIT_STAMP_ELISION_CONTROL_ENABLED_PROPERTY =
            "delosdb.experimental.mvccGen2CommitStampElisionControl.enabled";
    static final String GEN2_TRANSACTION_STATUS_VISIBILITY_ENABLED_PROPERTY =
