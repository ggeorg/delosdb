...
final class MvccRawStoreFormat {
    ...
    static final int DIRECTORY_PAYLOAD_START = DIRECTORY_HEAD_SUMMARY_FIELD_COUNT;

    static int directoryCurrentFieldCount(int columnCount) {
        return DIRECTORY_PAYLOAD_START + columnCount;
    }
