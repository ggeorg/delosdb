...
public final class StoragePhaseC15PlannedRouteSmoke {
    ...
    public static void main(String[] args) throws Exception {
        ...
        requireUpdateCount(execute("INSERT_VALUES", groups(TABLE_NAME, "2, 'bravo'"), owner),
                1L,
                "planned insert bravo");

        requireRows(execute("SELECT_ALL", groups(TABLE_NAME, null, null), owner), List.of("alpha", "bravo"));
        requireCount(execute("SELECT_COUNT", groups(TABLE_NAME), owner), 2);
