...
/** Test-only bridge for package-private lock-entry diagnostics. */
public final class LockEntryDiagnosticTestSupport {
    private LockEntryDiagnosticTestSupport() {
    }

    public static void reset() {
        ConcurrentLockSet.resetLockEntryDiagnosticsForTesting();
    }
