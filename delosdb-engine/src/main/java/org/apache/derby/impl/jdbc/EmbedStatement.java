...
public class EmbedStatement extends ConnectionChild
	...
	private java.sql.ResultSet versionedStorageResults;
		...
		throws SQLException
	{
		...
		if (versionedStorageResults != null) {
			return versionedStorageResults;
		}
	  ...
	  synchronized (getConnectionSynchronization()) {
		...
		try {
			VersionedStorageSqlResult versionedStorageResult =
					VersionedStorageSqlBridge.tryExecute(sql);
	...
	public final java.sql.ResultSet getResultSet() throws SQLException  {
		...
		return versionedStorageResults != null ? versionedStorageResults : results;
	}
