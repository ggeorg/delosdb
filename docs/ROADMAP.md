...
G1 should extend `DelosTableScanResultSet` predicate translation from equality to
range qualifiers and keep the same constraints: no new bridge route, no regex
