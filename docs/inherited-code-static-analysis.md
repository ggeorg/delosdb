...
- Proved the inherited Derby generated bytecode header.
- Tested classfile versions 45.3, 49.0, and 50.0 on Java 21.
- Moved the production generated classfile target from 45.3 to 50.0.
- Kept below classfile 51 to avoid Java 7+ StackMapTable requirements.
...
Current classfile constants:

```text
JAVA_CLASS_FORMAT_MAJOR_VERSION = 50
JAVA_CLASS_FORMAT_MINOR_VERSION = 0
```
...
- Generated classfile version should remain 50.0 unless StackMapTable support is added.
