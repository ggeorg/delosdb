...
public abstract class BTreeScan extends OpenBTree implements ScanManager
{
    ...
    */
    ...
    protected StoreDataValue[] init_template;
    protected StoreDataValue[] init_startKeyValue;
    protected int                   init_startSearchOperator = 0;
    protected Qualifier             init_qualifier[][]       = null;
    protected StoreDataValue[] init_stopKeyValue;
     ...
     **/
    protected StoreDataValue[][] fetchNext_one_slot_array = 
    ...
    **/
    ...
    final int trySnapshotPointRead(StoreDataValue[] row)
        ...
        if (!StoreValueCopySupport.copyValue(
                scan_position.current_lock_row_loc, rowLocationValue)) {
            return -1;
        }
        if (!getLockingPolicy().lockScanRowFromSnapshot(
    ...
    private boolean isSnapshotPointReadShape() throws StandardException {
        if (init_forUpdate || init_hold || init_qualifier != null
