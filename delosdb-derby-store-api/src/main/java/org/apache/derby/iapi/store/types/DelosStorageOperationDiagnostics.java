/*
   ...
   Derby - Class org.apache.derby.iapi.store.types.DelosStorageOperationDiagnostics
...
/** Provider-wide mutation, scan, candidate-index, and locator diagnostics. */
interface DelosStorageOperationDiagnostics {
